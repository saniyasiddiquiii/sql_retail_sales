...
1. **Write a SQL query to retrieve all columns for sales made on '2022-09-05**:
```sql
SELECT *
FROM retail_sales
...
4. **Write a SQL query to find the average age of customers who purchased items from the 'Electronic' category.**:
```sql
